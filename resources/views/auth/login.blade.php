                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6 offset-md-4">
                             <a href="{{ url('/login/facebook') }}" class="btn btn-facebook mr-2"><i class="fab fa-facebook-f"></i> Facebook</a>
                             <a href="{{ url('/login/google') }}" class="btn btn-google mr-2"><i class="fab fa-google"></i> Google</a>
                             <a href="{{ url('/login/linkedin') }}" class="btn btn-linkedin mr-2"><i class="fab fa-linkedin"></i> Linkedin</a>
